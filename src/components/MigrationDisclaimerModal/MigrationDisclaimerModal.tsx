...
const MigrationDisclaimerModal: React.FC<MigrationDisclaimerModalProps> = ({ onConfirm, onDismiss }) => {
  ...
  return (
    <Modal>
      ...
      <div>
        <StyledText>
          Due to the upgrade, all Lodge functionalities other than [Settle and withdraw] has been disabled for users
          who staked in legacy Lodge. Please withdraw all balances from the previous lodge after the update.
        </StyledText>
      </div>
      <ModalActions>
