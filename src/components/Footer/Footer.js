      ...
      <Container maxWidth="lg">
        <Grid container>
          ...
          <Grid item xs={6} style={{ textAlign: 'right' }}>
            <a
              href="https://twitter.com/frostfinance"
            ...
            <a
              href="https://github.com/frostfinance/frostfinance-frontend"
              rel="noopener noreferrer"
              target="_blank"
              className={classes.link}
            >
            ...
            <a href="https://t.me/frostfinance" rel="noopener noreferrer" target="_blank" className={classes.link}>
